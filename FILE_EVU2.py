...
def new(uid,pwx,tl):
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="112.0.5667.196", "Google Chrome";v="112.0.5667.196"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5667.196 Safari/537.36',
    'viewport-width': '980',}
